...
<body>
<div class="icon">Gefeliciteerd! ${loggedUser.name} U bent nu ingelogd.</div>

<form id="blogPost" action="/blogger/BlogPostServlet.do" method="post">
    <textarea class="input" cols="200" type="text" placeholder="subject" name="subject"></textarea><br><br>
    <textarea class="input" rows="50" cols="200" name="text" placeholder="text" name="text"></textarea><br>
    <div class="options">
        <input class="input" type="submit" placeholder="submit"/>
    </div>
</form>
<form id="logout" action="/LogoutServlet.do" method="post">
    <div class="options">
